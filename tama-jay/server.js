...
app.get('/new', (request, response) => {
  ...
  //Numbers 4, 5. CRUD= Read and update.
...
app.get('/articles', (request, response) => {
  // COMMENT: What number(s) of the full-stack-diagram.png image correspond to the following line of code? Which method of article.js is interacting with this particular piece of `server.js`? What part of CRUD is being enacted/managed by this particular piece of code?
  // Numbers 2, 3, 4, 5.  article.fetchAll.  CRUD =Read 
...
app.post('/articles', (request, response) => {
  ...
  // Numbers 1, 2, 3, 4, 5.  Article.prototype.insertRecord.  CRUD =Create i
  client.query(
    `INSERT INTO
...
app.put('/articles/:id', (request, response) => {
  // DONE: What number(s) of the full-stack-diagram.png image correspond to the following line of code? Which method of article.js is interacting with this particular piece of `server.js`? What part of CRUD is being enacted/managed by this particular piece of code?
  // Numbers 1, 2, 3, 4, 5. Article.prototype.updateRecord.  CRUD = Update.
  client.query(
    `UPDATE articles
    SET
...
app.delete('/articles/:id', (request, response) => {
  // DONE: What number(s) of the full-stack-diagram.png image correspond to the following line of code? Which method of article.js is interacting with this particular piece of `server.js`? What part of CRUD is being enacted/managed by this particular piece of code?
  // Numbers 2,3,4,5. Aricle.prototype.deleteRecord.  CRUD = delete.
  client.query(
...
app.delete('/articles', (request, response) => {
  //DONE: What number(s) of the full-stack-diagram.png image correspond to the following line of code? Which method of article.js is interacting with this particular piece of `server.js`? What part of CRUD is being enacted/managed by this particular piece of code?
  // Numbers 2,3,4,5. Article.truncateTable.  CRUD= delete.
  client.query(
...
// loading the changes into the DB.
loadDB();
...
function loadArticles() {
  // DONE: What number(s) of the full-stack-diagram.png image correspond to the following line of code? Which method of article.js is interacting with this particular piece of `server.js`? What part of CRUD is being enacted/managed by this particular piece of code?
  // Number 3. Aricle.prototype.updateRecord. CRUD = update.
...
function loadDB() {
  // DONE: What number(s) of the full-stack-diagram.png image correspond to the following line of code? Which method of article.js is interacting with this particular piece of `server.js`? What part of CRUD is being enacted/managed by this particular piece of code?
  // Numbers 3,4. Article.loadAll. CRUD = create
  client.query(`
